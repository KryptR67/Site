...
def init_db():
    ...
    cur.execute("""
        CREATE TABLE IF NOT EXISTS pets (
            ...
            shiny_demand        INTEGER DEFAULT 0,
            prismatic_demand    INTEGER DEFAULT 0,
            rainbow_demand      INTEGER DEFAULT 0,
    ...
    safe_columns = [
        ...
        "ALTER TABLE pets ADD COLUMN IF NOT EXISTS shiny_demand INTEGER DEFAULT 0",
        "ALTER TABLE pets ADD COLUMN IF NOT EXISTS prismatic_demand INTEGER DEFAULT 0",
        "ALTER TABLE pets ADD COLUMN IF NOT EXISTS rainbow_demand INTEGER DEFAULT 0",
